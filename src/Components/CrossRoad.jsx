    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
      ...
      >
        ...
        <div className="p-6 flex-grow">
          {/* <!-- Card Body --> */}
          <img src="/face.webp" width="auto" height="600px" alt="Face Recognition" className="hover:opacity-80" />
        </div>
      ...
      >
        ...
        <div className="p-6 flex-grow">
          {/* <!-- Card Body --> */}
          <img src="/color.webp" width="auto" height="600px" alt="Color Detection" className="hover:opacity-80" />
        </div>
        <div className="bg-gray-100 p-4 text-center">
          {/* <!-- Card Footer --> */}
